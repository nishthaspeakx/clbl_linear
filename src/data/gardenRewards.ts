...
export const GARDEN_REWARDS: RewardItem[] = [
  ...
  { id: 'garden_06', category: 'garden', name: 'Fountain', icon: '⛲', imageKey: 'fountain', unlockLevel: 3, isEquippable: false },
  { id: 'garden_08', category: 'garden', name: 'Slide', icon: '🛝', imageKey: 'slide', unlockLevel: 4, isEquippable: false },
  { id: 'garden_04', category: 'garden', name: 'Flower Pots', icon: '🪴', imageKey: 'flower_pots', unlockLevel: 5, isEquippable: false },
  { id: 'garden_03', category: 'garden', name: 'Garden Bench', icon: '🪑', imageKey: 'garden_bench', unlockLevel: 6, isEquippable: false },
  { id: 'garden_05', category: 'garden', name: 'Rose Garden', icon: '🌹', imageKey: 'rose_garden', unlockLevel: 7, isEquippable: false },
  { id: 'garden_07', category: 'garden', name: 'Swing', icon: '🎠', imageKey: 'swing', unlockLevel: 8, isEquippable: false },
